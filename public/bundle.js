...
var _contactList = __webpack_require__(77);

var _contactList2 = _interopRequireDefault(_contactList);

var _contactDetail = __webpack_require__(78);

var _contactDetail2 = _interopRequireDefault(_contactDetail);

var _groups = __webpack_require__(79);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.delContact = _this.delContact.bind(_this);
    ...
    _createClass(App, [{
        ...
        value: function addContact(contact) {
            ...
            var id = Math.max.apply(Math, contacts.map(function (c) {
                return c.id;
            })) + 1;
        ...
        key: 'delContact',
        value: function delContact(id) {

            this.setState({ contacts: this.state.contacts.filter(function (item) {
                    return item.id != id;
                }) });
        }
    }, {
        ...
        value: function editContact(contact) {
            ...
            this.setState({ contacts: this.state.contacts.map(function (el) {
                    return el.id === contact.id ? Object.assign({}, el, { name: contact.name, group: contact.group, mobile: contact.mobile }) : el;
                }) });
        }
    }, {
        key: 'addGroup',
        value: function addGroup(group) {
            ...
            var id = Math.max.apply(Math, groups.map(function (c) {
                return c.id;
            })) + 1;
        ...
        value: function delGroup(id) {
            ...
            this.setState({ groups: this.state.groups.filter(function (item) {
                    return item.id != id;
                }) });
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { basename: '/projects/react-contact-list' },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_reactRouterDom.Route, {
                            ...
                            render: function render() {
                                return _react2.default.createElement(_contactList2.default, {
                                    contacts: _this2.state.contacts,
                                    groups: _this2.state.groups,
                                    addContact: _this2.addContact,
                                    delContact: _this2.delContact
                                });
                            }
                        }),
                        _react2.default.createElement(_reactRouterDom.Route, {
                            path: '/groups',
                            render: function render() {
                                return _react2.default.createElement(_groups2.default, {
                                    groups: _this2.state.groups,
                                    addGroup: _this2.addGroup,
                                    delGroup: _this2.delGroup
                                });
                            }
                        }),
                        _react2.default.createElement(_reactRouterDom.Route, {
                            path: '/contact/:id',
                            render: function render() {
                                return _react2.default.createElement(_contactDetail2.default, {
                                    contacts: _this2.state.contacts,
                                    groups: _this2.state.groups,
                                    editContact: _this2.editContact
                                });
                            }
                        }),
                        _react2.default.createElement(_reactRouterDom.Route, {
...
var ContactList = function (_Component) {
    ...
    _createClass(ContactList, [{
        ...
        value: function render() {
            ...
            var list = contacts.map(function (contact) {
                return _react2.default.createElement(
                    'form',
                    { id: contact.id, onSubmit: _this2.handleDel, className: 'input-form', key: contact.id },
                    _react2.default.createElement(
                        _reactRouterDom.Link,
                        { to: "/contact/" + contact.id, className: 'list-item list-link' },
                        contact.name
                    ),
                    _react2.default.createElement(
                        'span',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.handleAdd, className: 'input-form' },
                    _react2.default.createElement('input', { type: 'text', id: 'name', value: this.state.name, onChange: this.handleChange, placeholder: 'Name' }),
                    _react2.default.createElement(
                        'select',
                        ...
                        groups.map(function (group) {
                            return _react2.default.createElement(
                                'option',
                                { key: group.id, name: group.name, value: group.name },
                                group.name
                            );
                        })
                    ),
                    _react2.default.createElement('input', { type: 'text', id: 'mobile', value: this.state.mobile, onChange: this.handleChange, placeholder: 'Mobile' }),
                    _react2.default.createElement(
                        'button',
                        { type: 'submit' },
                        '+'
...
var ContactDetail = function (_Component) {
    ...
    function ContactDetail(props) {
        ...
        _this.state = { id: '', name: '', group: '', mobile: '', msg: '' };
        _this.handleChange = _this.handleChange.bind(_this);
    ...
    _createClass(ContactDetail, [{
        ...
        value: function componentDidMount() {
            ...
            this.setState({ id: contact.id, name: contact.name, group: contact.group, mobile: contact.mobile });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.handleSubmit, className: 'detail-form' },
                    _react2.default.createElement('input', { type: 'text', id: 'name', value: this.state.name, onChange: this.handleChange, placeholder: 'Name' }),
                    _react2.default.createElement(
                        'select',
                        { id: 'group', value: this.state.group, onChange: this.handleChange },
                        groups.map(function (group) {
                            return _react2.default.createElement(
                                'option',
                                { key: group.id, name: group.name, value: group.name },
...
exports.default = (0, _reactRouterDom.withRouter)(ContactDetail);
    ...
    _createClass(Groups, [{
        ...
        value: function render() {
            ...
            var list = groups.map(function (group) {
                return _react2.default.createElement(
                    'form',
                    { id: group.id, onSubmit: _this2.handleDel, className: 'group-form', key: group.id },
                    _react2.default.createElement(
                        'span',
                        { className: 'list-item' },
                        group.name
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.handleAdd, className: 'group-form' },
                    _react2.default.createElement('input', { type: 'text', value: this.state.name, onChange: this.handleChange, placeholder: 'Name' }),
                    _react2.default.createElement(
                        'button',
                        { type: 'submit' },
                        '+'
